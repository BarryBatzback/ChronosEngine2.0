...
class LLMService:
    ...
    def __init__(self, config: Dict):
        ...
        self.model_coordinator = config.get("model_coordinator", "qwen2.5-coder:7b")
        self.model_specialist = config.get("model_specialist", "gemma2:9b")
        self.model_vision = config.get("model_vision", "gemma2:27b")
    ...
    async def generate_json(
        self, prompt: str, schema: Optional[Dict] = None, use_coordinator: bool = True
    ) -> Dict:
    ...
    async def _retry_json_parse(
        self, raw_response: str, schema: Optional[Dict]
    ) -> Dict:
    ...
    async def generate_code(self, prompt: str, language: str = "python") -> str:
        ...
        return await self.generate(
            prompt, use_coordinator=False, system_instruction=system_instruction
        )
