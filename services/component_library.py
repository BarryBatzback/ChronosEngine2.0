...
class ComponentLibrary:
    def __init__(self, assets_path: str = "assets"):
        ...
        logger.info(
            f"📦 ComponentLibrary initialized with assets from: {self.assets_path}"
        )
    ...
    def _initialize_component_library(self) -> Dict:
        ...
        return {
            "sword": {
                ...
                "handle": {
                    "basic": {
                        "file": "handles/basic_handle.blend",
                        "scale": 1.0,
                        "material": "wood",
                    }
                },
    ...
    def get_component(
        self, category: str, component_type: str, style: str = "basic"
    ) -> Optional[Dict]:
    ...
    def import_component_code(
        self, category: str, component_type: str, style: str, position: list
    ) -> str:
