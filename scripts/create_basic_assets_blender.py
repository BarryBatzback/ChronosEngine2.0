...
def create_basic_handle(assets_dir):
    ...
    bpy.ops.mesh.primitive_cylinder_add(vertices=16, radius=0.5, depth=1.0, location=(0, 0, 0))
...
def create_basic_materials(assets_dir):
    ...
    bpy.data.libraries.write(str(materials_path), set(bpy.data.materials), fake_user=True)
